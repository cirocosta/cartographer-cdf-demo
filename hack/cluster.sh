...
abort_with_help() {
        echo "usage: $0 [cmd ...]"
        echo "cmd: (start|apply-dependencies|apply-sc)"
        exit 1
}
...
install_sc() {
        ...
        ytt --ignore-unknown-comments \
                ...
                kapp deploy --yes -a sc --diff-changes -f-
}
